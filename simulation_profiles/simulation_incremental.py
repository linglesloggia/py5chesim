...
schedulerInter = "VN"  # RRp for improved Round Robin, PFXX for Proportional Fair
...
t_sim = 6000#12_000_000  # 60000 # (ms)
...
measInterv = 1000.0  # interval between meassures default 1000
"""Time interval (in milliseconds) between meassures for statistics reports."""
interSliceSchGr = 15  # 3000.0 # interSlice scheduler time granularity
...
# con estos tarda mucho:


# Perfiles de tráfico definidos para el modelo vanilla
"""
UEgroup1 = UEgroup(4,   0,  300,    0,      1,      0,    0  ,  'eMBB-0',   20,'','Rr','SU',4,cell1,t_sim,measInterv,env,'S37') #pareto u   0.64
UEgroup2 = UEgroup(8,   0,  500,    0,      1,      0,    0  ,  'eMBB-1',   20,'','Rr','SU',4,cell1,t_sim,measInterv,env,'S37') # br vid    2.06
UEgroup3 = UEgroup(2,    0,  200,    0,      1,      0,   0,  'eMBB-2',   20,'','Rr','SU',4,cell1,t_sim,measInterv,env,'S37') #unform tel 1.22
"""
# definido para apex BestEffort
UEgroup1 = UEgroup(
    4,
    0,
    500,
